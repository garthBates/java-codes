let fruits = ['Apple', 'Orange', 'Cherry', 'Mango', 'Pinapple']

// Add items to the end of an array
fruits.push('Pear');

console.log(fruits);
fruits.pop(); // Removes the last item of an array
console.log(fruits);
...
let removedFruits = fruits.splice(cherryIndex, 1); // Splice works similarly to substring
console.log(fruits);
